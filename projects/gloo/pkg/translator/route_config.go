...
func ValidateRouteDestinations(snap snapshotadapter.ApiSnapshot, action *v1.RouteAction) error {
...
func ValidateTcpRouteDestinations(snap snapshotadapter.ApiSnapshot, action *v1.TcpHost_TcpAction) error {
	upstreams := snap.Upstreams
	// make sure the destination itself has the right structure
	switch dest := action.GetDestination().(type) {
...
func validateUpstreamGroup(snap snapshotadapter.ApiSnapshot, ref *core.ResourceRef) error {
...
func validateMultiDestination(upstreams snapshotadapter.UpstreamList, destinations []*v1.WeightedDestination) error {
...
func validateSingleDestination(upstreams snapshotadapter.UpstreamList, destination *v1.Destination) error {
